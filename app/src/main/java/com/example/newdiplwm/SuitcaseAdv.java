...
public class SuitcaseAdv extends Fragment implements View.OnClickListener{
    ...
    private ImageView lid1, lid2, lid3, lid4, lid5, lid6;
    private ImageView base1, base2, base3, base4, base5, base6;
    ...
    public void assignAllImageViews() {
        ...
        Base = view.findViewById(R.id.SuitcaseAdv_Base_LinearLayout);
        Lid = view.findViewById(R.id.SuitcaseAdv_Lid_LinearLayout);

        base1 = view.findViewById(R.id.SuitcaseAdv_Base_imageView1);
        base2 = view.findViewById(R.id.SuitcaseAdv_Base_imageView2);
        base3 = view.findViewById(R.id.SuitcaseAdv_Base_imageView3);
        ...
        base5.setOnClickListener(this);
        base6.setOnClickListener(this);

        lid1 = view.findViewById(R.id.SuitcaseAdv_Lid_imageView1);
        lid2 = view.findViewById(R.id.SuitcaseAdv_Lid_imageView2);
        lid3 = view.findViewById(R.id.SuitcaseAdv_Lid_imageView3);
        lid4 = view.findViewById(R.id.SuitcaseAdv_Lid_imageView4);
        lid5 = view.findViewById(R.id.SuitcaseAdv_Lid_imageView5);
        lid6 = view.findViewById(R.id.SuitcaseAdv_Lid_imageView6);

        lid1.setOnClickListener(this);
        lid2.setOnClickListener(this);
        lid3.setOnClickListener(this);
        lid4.setOnClickListener(this);
        lid5.setOnClickListener(this);
        lid6.setOnClickListener(this);

    }

    public void initializeBaseIdsHashMap() {

        baseIDS.put(1, R.id.SuitcaseAdv_Base_imageView1);
        baseIDS.put(2, R.id.SuitcaseAdv_Base_imageView2);
        baseIDS.put(3, R.id.SuitcaseAdv_Base_imageView3);
        baseIDS.put(4, R.id.SuitcaseAdv_Base_imageView4);
        baseIDS.put(5, R.id.SuitcaseAdv_Base_imageView5);
        baseIDS.put(6, R.id.SuitcaseAdv_Base_imageView6);

    }

    public void initializeLidIdsHashMap() {

        lidIDS.put(2, R.id.SuitcaseAdv_Lid_imageView1);
        lidIDS.put(1, R.id.SuitcaseAdv_Lid_imageView2);
        lidIDS.put(4, R.id.SuitcaseAdv_Lid_imageView3);
        lidIDS.put(3, R.id.SuitcaseAdv_Lid_imageView4);
        lidIDS.put(5, R.id.SuitcaseAdv_Lid_imageView6);
        lidIDS.put(6, R.id.SuitcaseAdv_Lid_imageView5);
    ...
    public void unClickBase() {
        ...
        base5.setClickable(false);
        base6.setClickable(false);
    }
    ...
    public void unClickLid() {
        ...
        lid5.setClickable(false);
        lid6.setClickable(false);
    }
    ...
    public void clickAll() {
        ...
        base5.setClickable(true);
        base6.setClickable(true);

        lid1.setClickable(true);
        lid2.setClickable(true);
        lid3.setClickable(true);
        lid4.setClickable(true);
        lid5.setClickable(true);
        lid6.setClickable(true);
    }

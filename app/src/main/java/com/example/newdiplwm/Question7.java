...
public class Question7 extends Fragment implements View.OnClickListener{
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.question_seven, container, false);
        assignAllbuttons();
        return view;
    }
